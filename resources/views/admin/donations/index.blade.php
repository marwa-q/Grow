    ...
    <div class="card shadow-sm mb-4">
                            ...
                            <tr class="donation-row">
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-circle me-2 bg-light d-flex align-items-center justify-content-center"
                                ...
                                <td>
                                    <div>{{ $donation->created_at ? $donation->created_at->format('M d, Y') : 'Not Available' }}
                                    </div>

                                    <small class="text-muted">
                                        {{ $donation->created_at ? $donation->created_at->format('h:i A') : 'Not Available' }}
                                    </small>
        ...
        <div class="card-footer bg-white">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <small class="text-muted">Showing {{ $donations->count() }} of {{ $donations->total() }}
                        donations</small>
                </div>
