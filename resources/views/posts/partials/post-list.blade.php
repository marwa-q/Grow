    ...
    <button class="btn btn-light flex-fill ms-2 comment-btn rounded-pill py-1" data-post-id="{{ $post->id }}">
        ...
        <div class="comments-container bg-light p-3 d-none" id="comments-{{ $post->id }}">
            ...
            @auth
                <div class="d-flex">
                    <div class="avatar me-2">
                        <img src="{{ auth()->user()->profile_photo ?? asset('images/avatar.jpg') }}" class="rounded-circle"
                            width="32" height="32" alt="Avatar">
                    </div>
                    <div class="flex-grow-1">
                        <div class="input-group">
                            <input type="text" class="form-control rounded-pill comment-input" data-post-id="{{ $post->id }}"
                                placeholder="Write a comment...">
                            <button class="btn btn-primary rounded-pill ms-2 add-comment-btn"
